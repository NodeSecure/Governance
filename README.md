...
Find out more on our project discovery [README](https://github.com/NodeSecure/.github/tree/master/profile)
...
1. Notify the contribution by adding it with the [allcontributors](https://allcontributors.org/) bot
...
- [LinkedIn Company Account](https://www.linkedin.com/company/nodesecure): for communicating and promoting news around the project or project-related topics.
...
<table>
  <tr>
    <td align="center">
      <a href="https://github.com/fabnguess" target="_blank"></a>
        <img src="https://github.com/fabnguess.png?s=200" width="200px;" alt="Fabrice"/>
        <br />
        <div>
          <sub><b>Fabrice</b></sub>
        </div>
...
> [!NOTE]
> This work is a derivative of the [WebdriverIO governance](https://github.com/webdriverio/webdriverio/blob/main/GOVERNANCE.md#governance)
>
