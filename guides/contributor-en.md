...
- Look for issues with the label [newcomer](https://github.com/search?q=org%3ANodeSecure++++++label%3A%22newcomer%22&type=issues&state=open) (be aware that those are just the tip of the iceberg).
